...
// css *required
import { useStyles } from "./EditAccount.css";
...
const showMain = (props) => {
  const { classes, onCloseEditListModal, open, setError, editData } = props;
  return (
    <Dialog
      open={open}
      onClose={() => {
    ...
    >
      <DialogContent className={classes.dialogContent}>
        <Formik
          ...
          onSubmit={(v) => onUpdatedClicked({ ...v, ...props })}
        >
 ...
 * @param {*} params
 */
const onUpdatedClicked = (props) => {
  const { M, K, S, setList, setError, editData } = props;
  let obtainList = {
